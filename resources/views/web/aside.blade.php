<aside class="col-lg-4 sidebar-home">
    ...
    <!-- Promotion -->
    <div class="promotion">
        <img src="{{asset('web/images/promotion.jpg')}}" class="img-fluid w-100">
    ...
    <div class="widget widget-author">
        ...
        <div class="media align-items-center">
            <div class="mr-3">
                <img class="widget-author-image" src="{{asset('web/images/john-doe.jpg')}}">
            </div>
        ...
        <div class="media align-items-center">
            <div class="mr-3">
                <img class="widget-author-image" src="{{asset('web/images/kate-stone.jpg')}}">
            </div>
            <div class="media-body">
        ...
        <div class="media align-items-center">
            <div class="mr-3">
                <img class="widget-author-image" src="{{asset('web/images/john-doe.jpg')}}" alt="John Doe">
            </div>
            <div class="media-body">
    ...
    {{-- <div class="widget">
        ...
        <article class="widget-card">
            <div class="d-flex">
                <img class="card-img-sm" src="{{asset('web/images/post/post-10.jpg')}}">
                <div class="ml-3">
        ...
        <article class="widget-card">
            <div class="d-flex">
                <img class="card-img-sm" src="{{asset('web/images/post/post-7.jpg')}}">
                <div class="ml-3">
                    <h5><a class="post-title" href="post-details.html">Advice From a Twenty Something</a>
                    </h5>
                    <ul class="card-meta list-inline mb-0">
